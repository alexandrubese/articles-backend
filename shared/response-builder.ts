...
import {
  BadRequestResult, ConfigurationErrorResult, ErrorResult, ForbiddenResult, InternalServerErrorResult, NotFoundResult,
} from './errors';
...
export class ResponseBuilder {
  ...
  public static configurationError(code: string, description: string, callback: ApiCallback): void {
    ...
    ResponseBuilder.returnAs<ConfigurationErrorResult>(errorResult, HttpStatusCode.ConfigurationError, callback);
  }
  ...
  public static internalServerError(error: Error, callback: ApiCallback): void {
    ...
    ResponseBuilder.returnAs<InternalServerErrorResult>(errorResult, HttpStatusCode.InternalServerError, callback);
  }
